<?php
class IWD_StoreLocatori_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('storelocatori/image'));
    ...
    public function getPlaceholder()
    {
        if (!$this->_placeholder) {
            ...
            if (!empty($p)){
            	...
            	$this->_placeholder = 'iwd/storelocatori/placeholder/placeholder.png';
            }
        }
