...
class Plumrocket_OneStepCheckout_Block_System_Config_Version  extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    protected function _includeJs()
    {
        return '<script src="' .$this->getJsUrl('tiny_mce/tiny_mce.js') . '" type="text/javascript"></script>
          ...
          var wysiwygConfig = "' . $this->getSkinUrl('js/plumrocket/onestepcheckout/config.js') . '";
          var wysiwygEditorPath = "' . Mage::getUrl('adminhtml/catalog_category/wysiwyg') . '";
          </script>
          <script type="text/javascript" src="'. $this->getSkinUrl('js/plumrocket/onestepcheckout/jscolor/jscolor.js') . '"></script>
          <link href="' . $this->getSkinUrl('css/plumrocket/onestepcheckout/onestepcheckout.css').'" type="text/css" rel="stylesheet" />';
    }
