...
(function (o) {
    ...
    o.zoom = function (t, n, e, i) {
        ...
        return t.style.position = /(absolute|fixed)/.test(f) ? f : "relative", t.style.overflow = "hidden", e.style.width = e.style.height = "", o(e).addClass("zoomImg").css({position: "absolute", top: 0, left: 0, opacity: 0, width: e.width * i, height: e.height * i, border: "none", maxWidth: "none", maxHeight: "none"}).appendTo(t), {init: function () {
        ...
        return this.each(function () {
            ...
            s = !1,
            f = !1;
                      (i.url || (e = a.find("img"), e[0] && (i.url = e.data("data") || e.attr("data")), i.url)) && (function () {
