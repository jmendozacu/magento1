...
class Plumrocket_Onestepcheckout_CheckoutController extends Mage_Checkout_OnepageController {
    ...
    public function savePaymentAction($sendResponse = true) {
        ...
        try {
            ...
            /**
             * @todo Hoang Bien bert here
             */
//            print_r($result);
//            print_r($data);
//            echo get_class($this->getOnepage());
//            exit();
...
//            $redirectUrl = $this->getOnepage()->getCheckout()->getRedirectUrl();
    ...
    public function preSaveAction() {
        ...
        if ($this->getRequest()->getParam('steps')) {
            ...
            /**
             * @todo Will bug tommorrow
             */
            // file_put_contents(Mage::getBaseDir('var') . DIRECTORY_SEPARATOR . 'text.txt', date('Y-m-d H:i:s') . " :[" . $stringStepAction . "]\n", FILE_APPEND);
