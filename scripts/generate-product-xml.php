...
function getCategoryPath($categories) {
    ...
    for ($i = 0; $i < count($categories); $i++) {
        ...
        $categoryLink = str_replace(array('http://magento192.tv.net/', 'http://jetpilot.com.au/shop/int/', 'https://jetpilot.com.au/shop/int/','http://jetpilot.com.au/shop/', 'https://jetpilot.com.au/shop/', 'http://jetpilot.sydneyecommerce.com.au/shop/', 'https://jetpilot.sydneyecommerce.com.au/shop/'), '', $categoryLink);
        $name .= $categoryLink . '' . $dot;
    }
    return $name;
}
