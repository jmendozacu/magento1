<?php
class TM_ReviewReminder_Block_Adminhtml_Page_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    {
        return Mage::helper('tm_reviewreminder')->__("Edit Reminder");
    }
    /**
    ...
    {
        return $this->getUrl('*/*/send', array(
            '_current'   => true
        ));
    }
    protected function _prepareLayout()
    {
        $tabsBlock = $this->getLayout()->getBlock('reviewreminder_page_edit_tabs');
        if ($tabsBlock) {
