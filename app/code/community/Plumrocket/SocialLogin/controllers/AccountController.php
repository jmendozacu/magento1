...
class Plumrocket_SocialLogin_AccountController extends Mage_Core_Controller_Front_Action
{
        ...
        switch($model->getProtocol()) {
            ...
            case 'OpenID':
                try{
                    ...
                    $redirectUrl = Mage::helper('pslogin')->getCallbackURL($model->getProvider());
                    ...
                    if ($this->getRequest()->isPost()) {
                        ...
                        if (!$openid_id || !$consumer->login($openid_id, $redirectUrl, $redirectUrl, $profile)) {
                            $errorText = $this->__('OpenID login failed');
                        }
                    }
                }catch(Exception $e) {
                ...
                $form = $this->getLayout()
                    ...
                    ->setTemplate('pslogin/openid.phtml')
    ...
    public function loginAction()
    {
        ...
        if($this->getRequest()->isXmlHttpRequest()) {
            ...
            print_r($this->getResponse()->getBody());exit();
