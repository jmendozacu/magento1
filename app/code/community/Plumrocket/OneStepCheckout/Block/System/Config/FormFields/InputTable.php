...
class Plumrocket_OneStepCheckout_Block_System_Config_FormFields_InputTable
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
    ...
    public function addColumn($columnId, $column)
    {
        if (!$this->getContainerFieldId() || !$this->getRowKey()) {
            ...
            $this->_columns[$columnId] = $this->getLayout()->createBlock('onestepcheckout/system_config_formFields_inputTable_column')
                ->setData($column)
                ->setGrid($this);
        } else {
