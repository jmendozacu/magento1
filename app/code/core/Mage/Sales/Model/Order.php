...
/*
 * Cac gia tri cua order dc truyen vao bien 'order'        => $this,
 * Chung ta se lay duoc cac gia tri co trong order de hien thi tren mail
 * gui cho khach hang
 * print_r($this->getOnestepcheckoutCustomercomment());exit();
 * $mailer->send();
 */
