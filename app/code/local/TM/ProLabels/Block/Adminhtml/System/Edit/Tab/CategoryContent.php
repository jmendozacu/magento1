...
class TM_ProLabels_Block_Adminhtml_System_Edit_Tab_CategoryContent extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', array('legend'=>Mage::helper('prolabels')->__('Content (Category Page)'), 'class' => 'fieldset-wide'));
        ...
        $fieldset->addField('category_image_text', 'text', array(
        ...
        $fieldset->addField('category_custom_url', 'text', array(
        ...
        if ($this->getRequest()->getParam('rulesid') == '2' || $model->getData('rules_id') == '2') {
            ...
            $fieldset->addField('category_min_stock', 'text', array(
                'name'      => 'category_min_stock',
            ...
            $fieldset->addField('category_out_stock_image', 'image', array(
                'name'      => 'category_out_stock_image',
                'label'     => Mage::helper('prolabels')->__('Out of stock Image'),
                'title'     => Mage::helper('prolabels')->__('Out of stock Image')
            ));

            $fieldset->addField('category_out_text', 'text', array(
                'name'      => 'category_out_text',
                'label'     => Mage::helper('prolabels')->__('Out Of Stock Label Text'),
                'title'     => Mage::helper('prolabels')->__('Out Of Stock Label Text'),
            ));
        }

        $fieldset->addField('category_position_style', 'text', array(
            'name'      => 'category_position_style',
        ...
        $fieldset->addField('category_font_style', 'text', array(
        ...
        $fieldset->addField('category_round_method', 'select', array(
        ...
        $fieldset->addField('category_round', 'text', array(
            'name'      => 'category_round',
        ...
        if (!$model->getId()) {
            $model->addData(array('category_round' => '1'));
        }
