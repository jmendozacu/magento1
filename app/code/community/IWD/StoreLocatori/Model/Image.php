...
class IWD_StoreLocatori_Model_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
...
//        print '$this->_getNeedMemoryForBaseFile() = '.$this->_getNeedMemoryForBaseFile();
    ...
    public function setBaseFile($file)
    {
        ...
        if (!$file) {
        	...
        	$p = Mage::getStoreConfig('storelocatori/global/placeholder');
        	if (!empty($p)){
        		$configPlaceholder = 'gmmarker/' . $p;
        	}else{
        		$configPlaceholder   = '/iwd/storelocatori/placeholder/placeholder.png1';
        	}
            ...
            if ($isConfigPlaceholder && $this->_fileExists($baseDir . $configPlaceholder)) {
                ...
                $skinPlaceholder = "/iwd/storelocatori/placeholder/placeholder.png1";
        ...
        $path = array(
           	Mage::getBaseDir('media') . DS . 'iwd' . DS . 'storelocatori' ,
            'cache',
...
//            }
    ...
    protected function _getWatermarkFilePath()
    {
        ...
        $baseDir = Mage::getBaseDir('media') . DS . 'iwd' .DS . 'storelocatori';
    ...
    {
        $directory = Mage::getBaseDir('media') . DS . 'iwd' .DS . 'storelocatori' .DS . 'cache' . DS;
