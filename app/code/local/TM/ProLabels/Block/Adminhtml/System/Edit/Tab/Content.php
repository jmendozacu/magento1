...
class TM_ProLabels_Block_Adminhtml_System_Edit_Tab_Content extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('product_custom_url', 'text', array(
        ...
        if (!$model->getId()) {
            $model->addData(array('product_round' => '1'));
        }
