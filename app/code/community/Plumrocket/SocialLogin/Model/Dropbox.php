...
class Plumrocket_SocialLogin_Model_Dropbox extends Plumrocket_SocialLogin_Model_Account
{
	protected $_type = 'dropbox';
	
    protected $_url = 'https://www.dropbox.com/1/oauth2/authorize';
    ...
    public function loadUserData($response)
    {
        ...
        $token = null;
        if($response = $this->_callPost('https://api.dropbox.com/1/oauth2/token', $params)) {
        ...
        if (isset($token['access_token'])) {
            ...
            if($response = $this->_call('https://api.dropbox.com/1/account/info', $params)) {
