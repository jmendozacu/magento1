...
class TM_Highlight_Block_Review_New extends TM_Highlight_Block_Product_List
{
    ...
    protected function _beforeToHtml()
    {
        ...
        // return parent::_beforeToHtml(); do not call for parent to prevent event dispatching
    }
