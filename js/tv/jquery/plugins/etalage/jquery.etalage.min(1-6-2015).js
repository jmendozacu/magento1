 ...
 */
/*
 var $imgwidth = parseInt($thumbs.find('.etalage_thumb_image').width());
 if ($imgwidth > o.thumb_image_width) {
 var $thumb_images = $thumbs.find('.etalage_thumb_image').css({width: o.thumb_image_width, height: o.thumb_image_height}).show();
 }else{
 var $thumb_images = $thumbs.find('.etalage_thumb_image').css({width: 'auto', height: o.thumb_image_height}).show();
 }
 */
(function ($) {
