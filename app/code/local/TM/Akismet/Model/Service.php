...
class TM_Akismet_Model_Service 
{
    ...
    {
        $message = $this->_spamMessage;
        if (empty($message)) {
            $message = Mage::helper('akismet')->__('Sorry, but we think you\'re a spammer.');
        }
        return $message;
    }
     ...
     * @return \TM_Akismet_Model_Service
     */
    public function setSpamMessage($message)
    {
        $this->_spamMessage = (string) $message;
        return $this;
    }
