...
class Plumrocket_SocialLogin_Helper_Data extends Plumrocket_SocialLogin_Helper_Main
{
	...
	public function disableExtension()
	{
		...
		$connection->delete($resource->getTableName('core/config_data'), array($connection->quoteInto('path IN (?)', array('pslogin/general/enable', 'pslogin/general/replace_templates', 'pslogin/facebook/enable', 'pslogin/twitter/enable'))));
	...
	public function getPhotoPath($checkIsEnabled = true)
	{
		...
		if(!Mage::getSingleton('customer/session')->getLoginProvider()) {
        	return false;
        }
