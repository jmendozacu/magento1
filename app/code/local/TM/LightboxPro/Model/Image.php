<?php
class TM_LightboxPro_Model_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
    ...
    /**
     * @return TM_LightboxPro_Model_Image
     */
...
//        print '$this->_getNeedMemoryForBaseFile() = '.$this->_getNeedMemoryForBaseFile();
    ...
    public function setBaseFile($file)
    {
        ...
        $baseDir = Mage::getBaseDir('media') . DS . 'lightboxpro';
...
//            }
    ...
    {
        $directory = Mage::getBaseDir('media') . DS . 'lightboxpro' . DS . 'cache' . DS;
